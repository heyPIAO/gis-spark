...
public class PipelineBuilder implements Serializable {
    ...
    public PipelineBuilder precision(CoordinateReferenceSystem crs) {
        addLast(new Precision(crs));
        return this;
    }
    ...
    private static final class Precision extends Pipeline {

        private final CoordinatePrecisionReducerFilter precisionReducerFilter;
        ...
        Precision(CoordinateReferenceSystem crs) {
            ...
            if (pm != null) {
                ...
                this.precisionReducerFilter = null;
            }
        }
        ...
        protected Geometry _run(Geometry geom) throws Exception {
            ...
            geom.apply(precisionReducerFilter);
            return geom;
        }
