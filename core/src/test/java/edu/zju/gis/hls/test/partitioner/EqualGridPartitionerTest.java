 ...
 **/
@Slf4j
public class EqualGridPartitionerTest {
  ...
  public static void main(String[] args) throws Exception {
    ...
    SparkSession ss = SparkSession.builder()
      .master("local[4]")
      .appName("EqualGridPartitionerTest")
      .getOrCreate();
    ...
    DistributeSpatialIndex si = SpatialIndexFactory.getDistributedSpatialIndex(IndexType.EQUAL_GRID, new EqualGridIndexConfig(8));
