package org.apache.spark.sql.hls.dialect

import org.apache.spark.sql.execution.datasources.jdbc.{JDBCOptions, JdbcUtils}
import org.apache.spark.sql.hls.udt.GeometryUDT
import org.apache.spark.sql.jdbc.{JdbcDialect, JdbcType}
import org.apache.spark.sql.types.{ArrayType, AtomicType, BinaryType, BooleanType, ByteType, DataType, DateType, DecimalType, DoubleType, FloatType, IntegerType, LongType, MetadataBuilder, ShortType, StringType, TimestampType}

import java.sql.{Connection, Types}
import java.util.Locale

class GeometryDialect extends JdbcDialect {
