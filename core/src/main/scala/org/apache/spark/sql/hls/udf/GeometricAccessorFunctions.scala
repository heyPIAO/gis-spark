...
/**
 * minor change from Geomesa GeometricAccessorFunctions
 */
object GeometricAccessorFunctions {
  ...
  val ST_MakeValid: Geometry => Geometry = nullableUDF(geom => GeometryUtil.validedGeom3(geom))
