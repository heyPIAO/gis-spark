...
@Setter
@NoArgsConstructor
public abstract class DistributeSpatialPartioner extends Partitioner implements Serializable {

  protected Map<String, KeyRangeFeature> keyRanges;

  protected int partitionNum;

  public DistributeSpatialPartioner(int partitionNum) {
   ...
   * @return
   */
  public static <K, V extends Feature, P extends DistributeSpatialPartioner> FlatMapFunction getPreProcessFunction(P paritioner, boolean isClip) {
    return new FlatMapFunction<Tuple2<K, V>, Tuple2<String, V>>() {
      ...
      public Iterator<Tuple2<String, V>> call(Tuple2<K, V> in) throws Exception {
        ...
        List<KeyRangeFeature> keyRangeFeatures = paritioner.getKeyRangeFeatures(in._2);
